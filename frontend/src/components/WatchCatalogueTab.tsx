  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="rounded-lg border overflow-y-auto" style={{ maxHeight: '420px', borderColor: 'var(--cafe-border)' }}>
              ...
              <tbody>
                {filteredMovements.slice(0, 500).map(m => (
                  <tr key={m.key} style={{ borderTop: '1px solid var(--cafe-border)' }}>
                    ...
                    <td className="px-4 py-2 text-right" style={{ color: 'var(--cafe-text-muted)' }}>
