...
import { Users, Wrench, Receipt, LayoutDashboard, LogOut, Database, BarChart3, UserCog, Scissors, KeyRound, Building2, ClipboardList, Sparkles, Cpu } from 'lucide-react'
...
const nav = [
  ...
  { to: '/catalogue', label: 'Catalogue', icon: Cpu, feature: 'watch' as FeatureKey },
