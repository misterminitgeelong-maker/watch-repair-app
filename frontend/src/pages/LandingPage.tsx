...
import { MKT, DOTS, MARKETING_CSS } from '@/lib/marketingTheme'
 ...
 * category. Shares its design tokens with the other public-facing pages via
 * @/lib/marketingTheme; see that file for the "why" behind the palette split.
 */
