...
export type Conformance = [
  ...
  AcceptsBackend<Api.MinitAdministrationReport, Schema<'MinitAdministrationReport'>>,
  AcceptsBackend<Api.MinitHqEnterShopResponse, Schema<'MinitHqEnterShopResponse'>>,
  AcceptsBackend<Api.MinitShopAccessRow, Schema<'MinitShopAccessRow'>>,
  AcceptsBackend<Api.MinitSupportSessionRow, Schema<'MinitSupportSessionRow'>>,
