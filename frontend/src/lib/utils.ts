...
export const STATUS_LABELS: Record<string, string> = {
  ...
  at_third_party_for_quoting: 'At 3rd Party Repairer for Quoting',
  third_party_quote_approved: '3rd Party Repairer Approved Quote',
...
export const STATUS_COLORS: Record<string, string> = {
  ...
  at_third_party_for_quoting: 'bg-[var(--ms-badge-wait-bg)] text-[var(--ms-badge-wait-text)]',
  third_party_quote_approved: 'bg-[var(--ms-badge-blue-bg)] text-[var(--ms-badge-blue-text)]',
