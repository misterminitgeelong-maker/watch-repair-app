...
export const STATUS_COLORS: Record<string, string> = {
  ...
  quote_sent:                    'bg-[#E0E8F5] text-[#2E4A7A]',
  awaiting_booking_confirmation: 'bg-[#FFF4E0] text-[#B86B00]',
  booking_confirmed:             'bg-[#E0E8F5] text-[#2E4A7A]',
  booking_on_hold:               'bg-[#FDE8D8] text-[#A84F1A]',
  booking_completed:             'bg-[#D4E8D4] text-[#1F5C24]',
  job_delayed:                   'bg-[#FDE8D8] text-[#A84F1A]',
  work_completed:                'bg-[#D4E8D4] text-[#1F5C24]',
  invoice_paid:                  'bg-[#DFF0EC] text-[#2A6B65]',
  failed_job:                    'bg-[#F5E8E8] text-[#8B3A3A]',
